...
def main():
    ...
    parser.add_argument('-epochs', default=96, type=int, metavar='N',
                        help='number of total epochs to run')
    parser.add_argument('-j', default=4, type=int, metavar='N',
                        help='number of data loading workers (default: 4)')
    parser.add_argument('-data_dir', type=str, default='./datasets/CIFAR10DVS')
    parser.add_argument('-out_dir', type=str, help='root dir for saving logs and checkpoint', default='./logs/posterLogs/CIFAR10DVS')
    ...
    parser.add_argument('-gamma', default=0.001, type=float, help='gamma for StepLR')
    ...
    net = deepModelsCIFAR10DVS.__dict__[args.model](args.cnf)
    print(net)
    net.to(args.device)
    ...
    out_dir = os.path.join(args.out_dir, f'CIFAR10DVS_c128128_{args.model}_{args.cnf}_T_{args.T}_T_train_{args.T_train}_{args.opt}_lr_{args.lr}_epochs{args.epochs}')
